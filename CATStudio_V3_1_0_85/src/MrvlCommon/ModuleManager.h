#pragma once
#include "..\MrvlCommon\ModuleDefs.h"
#include "..\MrvlCommon\ResourceHandle.h"
#include "..\MrvlCommon\CATDocTemplate.h"
#include "..\MrvlCommon\GeneralMacroDefine.h"

class CCATDocTemplate;
class CATCORE_DLLEXPORT CModuleManager
{
public:
   CModuleManager(void);
   ~CModuleManager(void);
