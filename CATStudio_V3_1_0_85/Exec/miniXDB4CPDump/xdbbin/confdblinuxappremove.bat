...
@REM .\edconfdb.exe -confdb ..\xdb\confdb.ini -removetarget "Application Debugger for Linux Serial COM1" 
@REM .\edconfdb.exe -confdb ..\xdb\confdb.ini -removetarget "Application Debugger for Linux Serial COM2" 
@REM .\edconfdb.exe -confdb ..\xdb\confdb.ini -removetarget "Application Debugger for Linux USB" 
.\edconfdb.exe -confdb ..\xdb\confdb.ini -removetarget "Application Debugger for Linux UDP/IP" 
goto end
:end1
